           ...
           <div className="px-4 sm:px-8 xl:px-32  flex justify-between items-center py-5 ">
                <div>
                    ...
                    <div className="hidden lg:flex gap-7 items-center text-base font-collector">
                      ...
                      <button className={` w-[170px] mr-1 sm:w-[200px] bg-bgDarkLint py-2 rounded-[1000px] ${session ? 'block' : 'hidden'} lg:hidden border border-darkBorder hover:border-[#FFA5BD] font-inter text-left pl-5 text-[#808095] text-[14px]
                                  `} onClick={toggleModal}>
                                    Start searching...
                      </button> 
